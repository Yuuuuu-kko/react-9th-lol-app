    ...
    <main className="flex flex-col items-center justify-center min-h-screen text-center">
      ...
      <div className="flex flex-col gap-6">
        <Link href="/champions" className="flex flex-col items-center">
          <Image src={lol1} alt="챔피언 정보" width={400} height={400} />
          <div className="mt-2 text-lg font-medium">챔피언 불러오기</div>
        </Link>

        <Link href="/rotation" className="flex flex-col items-center">
          <Image src={lol2} alt="로테이션 정보" width={400} height={400} />
          <div className="mt-2 text-lg font-medium">로테이션 불러오기</div>
        </Link>

        <Link href="/items" className="flex flex-col items-center">
          <Image src={lol3} alt="아이템 정보" width={400} height={400} />
          <div className="mt-2 text-lg font-medium">아이템 불러오기</div>
        </Link>
      </div>
    </main>
  );
